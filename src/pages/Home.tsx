...
import "./Home.css";
import Panjang from "./mPanjang";
import MenuSuhu from "./mSuhu";
import Massa from "./mMassa";
import Waktu from "./mWaktu";
import ArusListrik from "./mArusListrik";
import IntensitasCahaya from "./mIntensitasCahaya";
import JumlahZat from "./mJumblahZat";
    ...
    <IonPage>
      <IonHeader className="test">
        <IonToolbar>
          ...
          <p className="ion-text-center ion-no-margin">By : Samuel Kaunang</p>
        </IonToolbar>
      </IonHeader>
